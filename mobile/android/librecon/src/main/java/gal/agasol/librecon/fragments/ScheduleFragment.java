...
import gal.agasol.librecon.R;
import gal.agasol.librecon.ScheduleDetailActivity;
import gal.agasol.librecon.adapters.ScheduleAdapter;
import gal.agasol.librecon.api.APILibrecon;
import gal.agasol.librecon.deserializers.ScheduleDeserializer;
import gal.agasol.librecon.deserializers.SpeakerDeserializer;
import gal.agasol.librecon.domains.LastModifiedDomain;
import gal.agasol.librecon.domains.MeDomain;
import gal.agasol.librecon.domains.ScheduleDomain;
import gal.agasol.librecon.domains.ScheduleSpeakerDomain;
import gal.agasol.librecon.domains.SpeakerDomain;
...
public class ScheduleFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setupTab(0, titleDayOne, R.id.first_content);
        setupTab(1, titleDayTwo, R.id.second_content);
    ...
    private void setupTab(int index, final String tag, final int res) {
    ...
    private void setupSwipes() {
        ...
        int orange = ContextCompat.getColor(getActivity(), R.color.librecon_main_orange);
        int orangeDark = ContextCompat.getColor(getActivity(),R.color.librecon_main_orange_dark);
            ...
            public boolean onQueryTextChange(String newText) {
                if (tabHost == null || mScheduleDayTwoAdapter == null || mScheduleDayOneAdapter == null) {
                    ...
                    if (tabHost.getCurrentTab() > 0) {
                        mScheduleDayTwoAdapter.getFilter().filter(newText);
                        mScheduleDayOneAdapter.getFilter().filter("");
                        return true;
                    } else {
                        mScheduleDayOneAdapter.getFilter().filter(newText);
