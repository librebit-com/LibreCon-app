...
import gal.agasol.librecon.utils.DateUtils;
...
public class MeetingDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mMeeting == null && mAssistant == null) {
            ...
            mMeeting = MeetingsDomain.getMeetingForId(this, Long.valueOf(meetingId != null ? meetingId : null));
            if (mMeeting != null) {
    ...
    private void setControlsValuesFromMeeting() {
        if (!mMeeting.getEmailShare()) {
            mEmail.setChecked(false);
        } else if (!mAssistant.getEmail().isEmpty() && mMeeting.getSendedByMe()){
        ...
        if (!mMeeting.getCellphoneShare()) {
            mPhone.setChecked(false);
        } else if (!mAssistant.getCellPhone().isEmpty() && mMeeting.getSendedByMe()){
    ...
    public class MeetingResponseTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject aVoid) {
            ...
            if (mustEnd) {
                ...
                mAcceptBtn.setBackgroundColor(ContextCompat.getColor(context, android.R.color.holo_green_light));
